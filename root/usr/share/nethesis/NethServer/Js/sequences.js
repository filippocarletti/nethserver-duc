...
var total = 0;
var breadCumbText = window.innerWidth*9/1920;

// Breadcrumb dimensions: width, height, spacing, width of tip/tail.
var b = {
  w: window.innerWidth*130/1920, h: 30, s: 3, t: 10
};
...
var vis = d3.select("#chart").append("svg:svg")
    ...
    .append("svg:g")
    .attr("id", "container")
    .attr("transform", "translate(" + (width - 240) / 2 + "," + height / 2.3 + ")");
...
function createVisualization(json) {
  ...
  sizeFolder.innerHTML = filesize(json.size);
